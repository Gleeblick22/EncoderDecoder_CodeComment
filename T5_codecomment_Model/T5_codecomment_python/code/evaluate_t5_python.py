# File: code/evaluate_t5_python.py
...
def main(predictions_path, test_path, output_dir):
    ...
    with open(os.path.join(output_dir, "evaluation_t5_python_scores.json"), "w", encoding="utf-8") as f:
    ...
    qual_path = os.path.join(output_dir, "t5_python_qualitative_examples.txt")
    with open(qual_path, 'w', encoding='utf-8') as f:
        f.write("Model: T5-Python Only\n")

# File: code/tokenized_bart_python_java.py
...
# === [5] Argument Parser ===
def parse_args():
    parser = argparse.ArgumentParser(description="Tokenize Python+Java dataset for BART")
    parser.add_argument('--input_dir', type=str, required=True, help='Directory containing train/valid/test JSONs')
